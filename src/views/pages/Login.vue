            ...
            <div class="vx-col sm:w-full md:w-full lg:w-1/2 d-theme-dark-bg">
              <div class="p-8 login-tabs-container">
                ...
                <vs-input
                    ...
                    v-model="password"
                    class="w-full mt-6 in-login-app" />
                <span class="text-danger text-sm">{{ errors.first('password') }}</span>
                  ...
                  <vs-button @click="abreRegister()" type="border">Register</vs-button>
                  <vs-button :disabled="!validateForm" @click="loginAttempt()" class="float-right">Login</vs-button>

                  <vs-divider></vs-divider>

                  <div style="display:none !important;" class="social-login-buttons flex flex-wrap items-center mt-4">
...
export default{
  ...
  methods: {
    ...
    loginAttempt () {
      ...
      this.$http.post(process.env.VUE_APP_BASE_API + 'login', credential)
        .then(e => {
